...
VERSION = "1.0.0"
GITHUB_REPO = "dmccreary/search-microsims"
GITHUB_REPORT_PATH = "docs/reports/microsim-metrics.md"
GITHUB_REPORT_URL = f"https://github.com/{GITHUB_REPO}/blob/main/{GITHUB_REPORT_PATH}"
...
def generate_markdown_report(data, completeness, distributions, repos, quality):
    ...
    lines = [
        ...
        f"**Source:** [{GITHUB_REPORT_PATH}]({GITHUB_REPORT_URL})",
        "",
        "## Executive Summary",
        "",
    ...
    lines.extend([
        ...
        "---",
        "",
        f"*This report was generated by `src/data-profiler/profile-microsims.py` v{VERSION}*",
    ])
