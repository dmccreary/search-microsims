...
| Glossary Terms | 236 | [Glossary](../glossary.md) | Defined terms |
| FAQs | 54 | [FAQ](../faq.md) | Frequently asked questions |
| Quiz Questions | 150 | - | Questions across all chapters |
| MicroSims | 19 | [Simulations](../sims/index.md) | Interactive MicroSims |
...
|-------------|-------------|---------------|-------|
| Diagrams | 62 | 62 | H4 headers starting with '#### Diagram:' |
| Equations | 25 | 25 | LaTeX expressions (inline and display) |
| Total Words | 95,775 | 72,199 | Words in markdown files |
| Links | 175 | 50 | Hyperlinks in markdown format |
| Equivalent Pages | 408 | 313 | Estimated pages (250 words/page + visuals) |
